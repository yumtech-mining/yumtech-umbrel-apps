...
#
# Local copy of Bitcoin Core's src/ipc/capnp/mining.capnp (v31.0), kept verbatim
# so the derived wire type ids and method ordinals match the bitcoin-node server.
#
# Run:
#     capnp compile -o c++ mining.capnp common.capnp
# to generate the C++ headers and client stubs needed by ipc_mining.cpp.
